...
class DataCite47Schema(BaseSerializerSchema):
    """DataCite JSON 4.7 Marshmallow Schema."""
    ...
    def get_related_identifiers(self, obj):
        ...
        for rel_id in identifiers:
            ...
            if id_scheme and id_scheme.lower() in RELATED_IDENTIFIER_SCHEMES:
                ...
                relation_type_information = rel_id.get("relation_type_information")

                if relation_type_information:
                    serialized_identifier["relationTypeInformation"] = (
