...
class RDMRecordService(RecordService):
    ...
    def reserve_pid(self, id_, identity, pid_type):
        ...
        # PIDS-FIXME: Where should client come from? URL?
        client = "datacite"
        provider = self.get_provider(pid_type, client=client)
    ...
    def delete_pid(self, id_, identity, pid_type):
        ...
        # PIDS-FIXME: client should not be hardcoded
        client = "datacite"
        provider = self.get_provider(pid_type, client=client)
