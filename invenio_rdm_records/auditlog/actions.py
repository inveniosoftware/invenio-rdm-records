...
from .context import DiffContext, ResourceContext
...
class RDMRecordSecretLinkAuditLog(ParentBaseAuditLog):
    ...
    message_template = "User {user_id} updated secret link of {resource_type} {resource_id} via record."
...
class RDMRecordAccessSettingsAuditLog(ParentBaseAuditLog):
    ...
    message_template = "User {user_id} updated access settings of {resource_type} {resource_id} via record."
...
class RDMDraftAccessSettingsAuditLog(RDMRecordAccessSettingsAuditLog):
    ...
    message_template = "User {user_id} updated access settings of {resource_type} {resource_id} via draft."
