...
To enable users to modify the files of their records add
...
to your invenio.cfg. Also check whether you also want to pass a custom grace period or
change RDM_FILE_MODIFICATION_PERIOD.
