...
export class CreatibutorsModal extends Component {
  ...
  serializeCreatibutor = (submittedCreatibutor) => {
    const { initialCreatibutor } = this.props;
    if (this.props.serializeCreatibutor) {
      return this.props.serializeCreatibutor(submittedCreatibutor, initialCreatibutor);
    }
  ...
  deserializeCreatibutor = (initialCreatibutor) => {
    if (this.props.deserializeCreatibutor) {
      return this.props.deserializeCreatibutor(initialCreatibutor);
    }
    const identifiersFieldPath = "person_or_org.identifiers";
                ...
                <Form>
                  ...
                  {_get(values, typeFieldPath, "") === CREATIBUTOR_TYPE.PERSON ? (
                    <>
                      {autocompleteNames !== NamesAutocompleteOptions.OFF && (
                        <Overridable id="InvenioRDMRecords.CreatibutorsModal.PersonRemoteSelectField">
                          <RemoteSelectField
                            selectOnBlur={false}
                      ...
                      {showPersonForm && (
                        <>
                          <Form.Group widths="equal">
                            <Overridable id="InvenioRDMRecords.CreatibutorsModal.FamilyNameField">
                              <TextField
                            ...
                            <Overridable id="InvenioRDMRecords.CreatibutorsModal.GivenNameField">
                              <TextField
                          ...
                          <Overridable
                            id="InvenioRDMRecords.CreatibutorsModal.PersonIdentifiersField"
                          ...
                          <Overridable
                            id="InvenioRDMRecords.CreatibutorsModal.PersonAffiliationsField"
                    ...
                    <>
                      {autocompleteNames !== NamesAutocompleteOptions.OFF && (
                        <Overridable id="InvenioRDMRecords.CreatibutorsModal.OrganizationRemoteSelectField">
                          <RemoteSelectField
                            selectOnBlur={false}
                            selectOnNavigation={false}
                            searchInput={{
                      ...
                      <Overridable id="InvenioRDMRecords.CreatibutorsModal.OrganizationNameField">
                        <TextField
                      ...
                      <Overridable
                        id="InvenioRDMRecords.CreatibutorsModal.OrganizationIdentifiersField"
                        ref={this.identifiersRef}
                      >
                        <CreatibutorsIdentifiers
                          initialOptions={_map(
                      ...
                      <Overridable id="InvenioRDMRecords.CreatibutorsModal.OrganizationAffiliationsField">
                        <AffiliationsField
                          fieldPath={affiliationsFieldPath}
                          selectRef={this.affiliationsRef}
                        />
                  ...
                  {(_get(values, typeFieldPath) === CREATIBUTOR_TYPE.ORGANIZATION ||
                    (showPersonForm &&
                      _get(values, typeFieldPath) === CREATIBUTOR_TYPE.PERSON)) && (
                    <Overridable
                      id={`InvenioRDMRecords.CreatibutorsModal.RoleSelectField.${this.props.schema}`}
                    >
                      <SelectField
