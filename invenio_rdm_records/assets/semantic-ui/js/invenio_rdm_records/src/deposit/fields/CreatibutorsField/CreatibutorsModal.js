                ...
                <Form>
                  ...
                  {_get(values, typeFieldPath, "") === CREATIBUTOR_TYPE.PERSON ? (
                    <>
                      {autocompleteNames !== NamesAutocompleteOptions.OFF && (
                        <Overridable
                          id="InvenioRDMRecords.CreatibutorsModal.PersonRemoteSelectField"
                      ...
                      {showPersonForm && (
                        <>
                          <Overridable
                            id="InvenioRDMRecords.CreatibutorsModal.FullNameField"
                    ...
                    <>
                      {autocompleteNames !== NamesAutocompleteOptions.OFF && (
                        <Overridable
                          id="InvenioRDMRecords.CreatibutorsModal.OrganizationRemoteSelectField"
                          initialCreatibutor={initialCreatibutor}
                          serializeSuggestions={
                            serializeSuggestions || this.serializeSuggestions
                          }
                      ...
                      <Overridable
                        id="InvenioRDMRecords.CreatibutorsModal.OrganizationNameField"
                      ...
                      <Overridable
                        id="InvenioRDMRecords.CreatibutorsModal.OrganizationAffiliationsField"
                        fieldPath={affiliationsFieldPath}
                        ref={this.affiliationsRef}
                      >
                        <AffiliationsField
                  ...
                  {(_get(values, typeFieldPath) === CREATIBUTOR_TYPE.ORGANIZATION ||
                    (showPersonForm &&
                      _get(values, typeFieldPath) === CREATIBUTOR_TYPE.PERSON)) && (
                    <Overridable
                      id="InvenioRDMRecords.CreatibutorsModal.RoleSelectField"
