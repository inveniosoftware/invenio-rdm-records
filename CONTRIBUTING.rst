...
2. Clone your fork locally:
   ...
   .. code-block:: console
      ...
      $ git clone git@github.com:your_name_here/invenio-rdm-records.git
...
3. The pull request should work for Python 2.7, 3.5 and 3.6. Check
   https://github.com/inveniosoftware/invenio-rdm-records/actions?query=event%3Apull_request
