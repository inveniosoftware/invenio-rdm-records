...
def test_datacite45_serializer(running_app, full_record_to_dict):
    """Test serializer to DataCite 4.5 JSON"""
    ...
    serializer = DataCite45JSONSerializer()
    serialized_record = serializer.dump_obj(full_record_to_dict)

    assert serialized_record == expected_data


def test_datacite45_xml_serializer(running_app, full_record_to_dict):
    """Test serializer to DataCite 4.5 XML"""
    expected_data = (
...
def test_datacite45_alternate_identifiers(running_app, minimal_record):
...
def test_datacite45_access_right(running_app, minimal_record, set_app_config_fn_scoped):
...
def test_datacite45_serializer_with_unknown_id_schemes(
    running_app, full_modified_record
):
    """Test if the DataCite 4.5 JSON serializer can handle unknown schemes."""
...
def test_datacite45_xml_serializer_with_unknown_id_schemes(
    running_app, full_modified_record
):
    """Test if the DataCite 4.5 XML serializer can handle unknown schemes."""
    serializer = DataCite45XMLSerializer()
...
def test_datacite45_serializer_with_box(running_app, full_geolocation_box_record):
    """Test if the DataCite 4.5 JSON serializer handles geolocation boxes."""
...
def test_datacite45_serializer_with_polygon(
    running_app, full_geolocation_polygon_record
):
    """Test if the DataCite 4.5 JSON serializer handles geolocation polygons."""
...
def test_datacite45_serializer_updated_date(running_app, full_modified_date_record):
    """Test if the DataCite 4.5 JSON serializer adds system updated date."""
...
def test_datacite45_serializer_empty_record(running_app, empty_record):
    """Test if the DataCite 4.5 JSON serializer handles an empty record."""
