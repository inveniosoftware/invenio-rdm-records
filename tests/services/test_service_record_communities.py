...
def test_remove_community_component_called(
    ...
    class MockRemoveComponent(ServiceComponent):
        def remove_community(
            self, identity, record, community, valid_data, errors, uow
        ):
