...
class FakeCrossrefClient(providers.CrossrefClient):
    ...
    def api(self):
        ...
        if self._api is None:
            ...
            self._api = FakeCrossRefXMLClient(
                self.cfg("username"),
                self.cfg("password"),
                self.cfg("prefix"),
